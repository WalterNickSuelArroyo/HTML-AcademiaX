...
- Desarrollador web: Los desarrolladores web utilizan lenguajes de programación como HTML, CSS y JavaScript para crear y mantener sitios web y aplicaciones web.
...
# 5. Descargando e instalando IDE(VSC)
